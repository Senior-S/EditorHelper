...
namespace SDG.Unturned
{
    public class SleekGrid<T> : SleekWrapper where T : class
    {
        ...
        private ISleekBox _scrollBackground;
        ...
        public float ContentHeight => _verticalScrollView.ContentSizeOffset.y;
        ...
        private void UpdateVisibleEntries(float normalizedScrollPosition)
        {
            ...
            for (int i = _visibleEntries.Count - 1; i >= 0; i--)
            {
                ...
                if (OnRemoveElement != null) OnRemoveElement(visibleEntry.Element);
            ...
            _verticalScrollView.ForceLayoutUpdate(); // Had issues with incorrect ordering without this
        }
        ...
        public void ForceRebuildElements()
        {
            ...
            _verticalScrollView.ContentSizeOffset = new Vector2(0f, (Rows * (itemHeight + itemPadding)) - (Rows > 0 ? itemPadding : 0f));
