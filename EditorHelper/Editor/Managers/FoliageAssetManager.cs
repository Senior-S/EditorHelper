...
public class FoliageAssetManager
{
    ...
    public void CustomUpdate(EditorTerrainDetailsUI uiInstance)
    {
        bool visibility = uiInstance.tool.mode != FoliageEditor.EFoliageMode.BAKE && uiInstance.searchTypeButton.state == 0
            && uiInstance.tool.selectedInstanceAsset != null;
        ...
        if (uiInstance.tool.selectedInstanceAsset != null)
            _densityField.Value = uiInstance.tool.selectedInstanceAsset.density;
